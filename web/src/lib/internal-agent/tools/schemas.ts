...
export const internalAgentToolSchemas = {
    ...
    canvas_create_generation_flow: z.object({ ...projectWriteSchema, prompt: z.string().max(100_000), title: z.string().max(500).optional(), mode: generationModeSchema.optional(), x: z.number().finite().optional(), y: z.number().finite().optional(), referenceNodeIds: z.array(idSchema).optional(), ...generationOptionsSchema }).strict(),
