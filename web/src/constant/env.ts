...
export const PLUGIN_REGISTRY_URL = import.meta.env.VITE_PLUGIN_REGISTRY_URL || "https://cdn.jsdelivr.net/gh/onelxw/canvas-agent@plugins-dist/official-plugins.json";
