export default {
    ...
    settingsPanels: {
        ...
        image: { title: "图像设置", quality: "质量", size: "尺寸", align16: "16 倍数对齐", align16Hint: "输入完成后自动向上补成 16 的倍数", aspectRatio: "比例", adaptiveResolution: "自适应分辨率", transparent: "透明背景", transparentHint: "开启后生成无背景的透明图像（仅部分模型可用）", count: "生成张数", images: "{{count}} 张" },
        video: { title: "视频设置", quality: "清晰度", size: "尺寸", seconds: "秒数", resolution: "分辨率", ratio: "比例", duration: "时长", smart: "智能", output: "输出", generateAudio: "生成声音", watermark: "添加水印", adaptive: "自适应", adaptiveResolution: "自适应分辨率", sizes: { landscape: "横屏", portrait: "竖屏", square: "方形", widescreen: "宽屏", tall: "长图", auto: "自动" }, ratios: { landscape: "横屏", portrait: "竖屏", square: "方形", standardLandscape: "标准横屏", standardPortrait: "标准竖屏", cinematic: "宽银幕", adaptive: "自适应" } },
    ...
    canvas: {
        ...
        resetView: "重置视图",
        zoom: "放大/缩小画布",
        agentConnected: "Agent 已就绪",
        agentConnecting: "Agent {{activity}}",
        agentDisconnected: "Agent 未就绪",
        connecting: "连接中",
    ...
    config: {
        ...
        fileSecurity: "导出的 JSON 默认不包含 API Key 和 WebDAV 密码。",
        import: "导入配置",
        export: "导出配置",
        imported: "配置与用户偏好已导入",
